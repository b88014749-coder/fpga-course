...
//To make simulation faster in vivado
#define SIMULATION
...
#ifdef SIMULATION
#define TIMER_LED_RESET_VALUE    1000
#else
...
#ifdef SIMULATION
#define TIMER_BTN_RESET_VALUE(t)   1000
#define TIMER_BTN_DEB_INTERVAL_MS  2
#else
...
static int gpio_Init(void)
{
    ...
    XGpio_DiscreteWrite(&led_gpio, GPIO_CHANNEL, LED(0));
