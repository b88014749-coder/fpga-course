...
module tb_expr;
    ...
    task automatic check_case;
        ...
        begin
            ...
            // expr_plain: result ready 2 cycle later
            @(posedge clk);
            @(posedge clk); #1;
            ...
            // expr_pipelined: result ready 1 MORE cycle later (3 total)
            @(posedge clk); #1;
    ...
    initial begin
        ...
        // ((5+3)*4)+((10+3)*5)=32+65=97
        check_case(16'd5, 16'd3, 16'd4, 16'd10, 32'd97, "case1: ((5+3)*4)+((10+3)*5)=97");

        // ((10+20)*2)+((5+20)*10)=60+250=310
        check_case(16'd10, 16'd20, 16'd2, 16'd5, 32'd310, "case2: ((10+20)*2)+((5+20)*10)=310");
